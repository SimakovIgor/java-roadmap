...
![Урок](https://img.shields.io/badge/урок-8%20из%209-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-junior-16a34a)
![Тема](https://img.shields.io/badge/тема-JDBC%20·%20SQL%20·%20ResultSet-8b5cf6)

JDBC (Java Database Connectivity) это стандартный API для работы с реляционными базами из Java: подключение, SQL-запросы, чтение результатов.

<p align="center">
  <img src="assets/jdbc-flow.svg" width="860" alt="JDBC: приложение через Connection и PreparedStatement выполняет SQL и читает ResultSet из базы данных">
</p>
...
[← Работа с JSON (Урок 7)](07-json.md) · [Оглавление](../README.md) · [Java Stream API (Урок 9) →](09-streams.md)
