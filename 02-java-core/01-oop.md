...
![Урок](https://img.shields.io/badge/урок-1%20из%209-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-junior-16a34a)
![Тема](https://img.shields.io/badge/тема-интерфейсы%20·%20enum%20·%20вложенные%20классы-8b5cf6)

Принципы ООП, классы, объекты, интерфейсы, перечисления, внутренние/вложенные/анонимные/локальные классы.

<p align="center">
  <img src="assets/interface-contract.svg" width="860" alt="Интерфейс это контракт: Payable описывает метод pay(), а Card, Cash, Crypto реализуют его каждый по-своему">
</p>
...
[← Практика ООП (Fundamentals 7)](../01-fundamentals/07-strings-practice.md) · [Оглавление](../README.md) · [Обработка исключений (Урок 2) →](02-exceptions.md)
