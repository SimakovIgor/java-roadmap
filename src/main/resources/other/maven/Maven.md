...
![Раздел](https://img.shields.io/badge/раздел-Other%20·%20Maven-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-с%20нуля-16a34a)
![Тема](https://img.shields.io/badge/тема-сборка%20·%20зависимости%20·%20lifecycle-8b5cf6)

<p align="center">
  <img src="assets/maven-lifecycle.svg" width="860" alt="Жизненный цикл сборки Maven: validate → compile → test → package → verify → install">
</p>
...
переменные среды `MAVEN_HOME` в пути `~\maven\` в зависимости от того, куда его распаковали.
...
[← JUnit + Mockito](../junit/junit-mockito.md) · [Оглавление](../../../../../README.md) · [Инфраструктура →](../infrastructure/infrastructure.md)
