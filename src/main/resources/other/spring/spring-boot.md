...
![Раздел](https://img.shields.io/badge/раздел-Spring%20·%202%20из%205-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-middle-16a34a)
![Стек](https://img.shields.io/badge/стек-Java%2021%20·%20Spring%20Boot%203-8b5cf6)

<p align="center">
  <img src="assets/spring-boot-starter.svg" width="860" alt="Spring Boot: одна зависимость-стартер автоконфигурирует встроенный Tomcat, DispatcherServlet, Jackson и прочее с разумными умолчаниями">
</p>
...
[← Spring Core](spring-core.md) · [Оглавление](../../../../../README.md) · [Spring Data JPA →](spring-data.md)
