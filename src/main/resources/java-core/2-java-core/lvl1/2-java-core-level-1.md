...
[← Практика ООП (Fundamentals 7)](../../1-java-fundamentals/lvl7/1-java-fundamentals-level-7.md) · [Оглавление](../../../../../../README.md) · [Обработка исключений (Урок 2) →](../lvl2/2-java-core-level-2.md)
