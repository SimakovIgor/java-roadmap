...
![Урок](https://img.shields.io/badge/урок-9%20из%209-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-junior-16a34a)
![Тема](https://img.shields.io/badge/тема-Stream%20·%20filter%20·%20map%20·%20collect-8b5cf6)

Функциональное программирование на Java

<p align="center">
  <img src="../assets/stream-pipeline.svg" width="860" alt="Stream-конвейер: источник, промежуточные ленивые операции filter и map, терминальная операция collect запускает всю цепочку">
</p>
...
**filter()**, **map()** и **sorted()** это промежуточные операции. А
...
[← JDBC (Урок 8)](../lvl8/2-java-core-level-8.md) · [Оглавление](../../../../../../README.md)
