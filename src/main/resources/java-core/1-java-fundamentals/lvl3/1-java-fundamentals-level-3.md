...
![Урок](https://img.shields.io/badge/урок-3%20из%207-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-с%20нуля-16a34a)
![Тема](https://img.shields.io/badge/тема-практика%20·%20консоль-8b5cf6)
...
```java
String str = "apple";
char a = str.charAt(0); // вернет char, который стоит в слове str на первой позиции
```
...
[← Основные конструкции (Урок 2)](../lvl2/1-java-fundamentals-level-2.md) · [Оглавление](../../../../../../README.md) · [Крестики-нолики (Урок 4) →](../lvl4/1-java-fundamentals-level-4.md)
