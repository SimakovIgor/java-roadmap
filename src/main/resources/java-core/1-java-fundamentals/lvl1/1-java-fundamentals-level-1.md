...
Дальше по программе — [оператор `switch`, циклы и массивы](../lvl2/1-java-fundamentals-level-2.md). Но сначала закрепи основы практикой.
...
[Оглавление](../../../../../../README.md) · [Основные конструкции (Урок 2) →](../lvl2/1-java-fundamentals-level-2.md)
