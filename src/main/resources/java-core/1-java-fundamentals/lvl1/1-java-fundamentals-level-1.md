...
Java Development Kit (JDK), которые свободно предоставляется компанией
Oracle. JDK версии 21 можно загрузить [здесь](https://www.oracle.com/java/technologies/downloads/)

JDK 21 является актуальной LTS-версией на данный момент, рекомендуется
использовать именно ее для изучения языка Java.
...
через свойство <maven.compiler.release>21</maven.compiler.release>
(в соответствии с установленной у вас версией JDK).
