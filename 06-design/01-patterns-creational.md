...
![Раздел](https://img.shields.io/badge/раздел-Паттерны%20·%20порождающие-3b82f6)
![Уровень](https://img.shields.io/badge/уровень-middle-16a34a)
![Тема](https://img.shields.io/badge/тема-Factory%20·%20Builder%20·%20Singleton%20·%20Prototype-8b5cf6)
...
![](assets/patterns/factory-method.png)
...
![](assets/patterns/abstract-factory.png)
...
[Оглавление](../README.md) · [Структурные паттерны →](02-patterns-structural.md)
